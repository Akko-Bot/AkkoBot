...
namespace AkkoBot.Migrations
{
    ...
    [Migration("20220104075436_GuildLogExpansion")]
    partial class GuildLogExpansion
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AkkoCore.Services.Database.Entities.AliasEntity", b =>
                {
                    ...
                    b.HasComment("Stores command aliases.");
                });
            ...
            modelBuilder.Entity("AkkoCore.Services.Database.Entities.AutoCommandEntity", b =>
                {
                    ...
                    b.HasComment("Stores command data and the context it should be automatically sent to.");
                });
            ...
            modelBuilder.Entity("AkkoCore.Services.Database.Entities.AutoSlowmodeEntity", b =>
                {
                    ...
                    b.ToTable("auto_slowmode", (string)null);

                    b.HasComment("Stores the settings for the automatic slow mode of a Discord server.");
                });
            ...
            modelBuilder.Entity("AkkoCore.Services.Database.Entities.BlacklistEntity", b =>
                {
                    ...
                    b.HasComment("Stores users, channels, and servers blacklisted from the bot.");
                });
            ...
            modelBuilder.Entity("AkkoCore.Services.Database.Entities.CommandCooldownEntity", b =>
                {
                    ...
                    b.ToTable("command_cooldown", (string)null);

                    b.HasComment("Stores commands whose execution is restricted by a cooldown.");
                });
            ...
            modelBuilder.Entity("AkkoCore.Services.Database.Entities.DiscordUserEntity", b =>
                {
                    ...
                    b.HasComment("Stores data related to individual Discord users.");
                });
            ...
            modelBuilder.Entity("AkkoCore.Services.Database.Entities.FilteredContentEntity", b =>
                {
                    ...
                    b.ToTable("filtered_content", (string)null);

                    b.HasComment("Stores the content filters to be applied to a Discord channel.");
                });
            ...
            modelBuilder.Entity("AkkoCore.Services.Database.Entities.FilteredWordsEntity", b =>
                {
                    ...
                    b.ToTable("filtered_words", (string)null);

                    b.HasComment("Stores filtered words of a Discord server.");
                });
            ...
            modelBuilder.Entity("AkkoCore.Services.Database.Entities.GatekeepEntity", b =>
                {
                    ...
                    b.ToTable("gatekeeping", (string)null);

                    b.HasComment("Stores settings and data related to gatekeeping.");
                });
            ...
            modelBuilder.Entity("AkkoCore.Services.Database.Entities.GuildConfigEntity", b =>
                {
                    ...
                    b.HasComment("Stores settings and data related to a Discord server.");
                });
            ...
            modelBuilder.Entity("AkkoCore.Services.Database.Entities.GuildLogEntity", b =>
                {
                    ...
                    b.ToTable("guild_logs", (string)null);

                    b.HasComment("Stores information about a guild log.");
                });

            modelBuilder.Entity("AkkoCore.Services.Database.Entities.ModroleEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<decimal>("ModroleId")
                        .HasColumnType("numeric(20,0)")
                        .HasColumnName("modrole_id");

                    b.Property<List<long>>("TargetRoleIds")
                        .IsRequired()
                        .HasColumnType("bigint[]")
                    ...
                    b.HasIndex("GuildIdFK")
                        .HasDatabaseName("ix_modroles_guild_id_fk");

                    b.ToTable("modroles", (string)null);

                    b.HasComment("Stores modrole data.");
                });
            ...
            modelBuilder.Entity("AkkoCore.Services.Database.Entities.MutedUserEntity", b =>
                {
                    ...
                    b.HasComment("Stores data about users that got muted in a specific server.");
                });
            ...
            modelBuilder.Entity("AkkoCore.Services.Database.Entities.OccurrenceEntity", b =>
                {
                    ...
                    b.HasComment("Stores the amount of infractions commited by a user in a server.");
                });
            ...
            modelBuilder.Entity("AkkoCore.Services.Database.Entities.PermissionOverrideEntity", b =>
                {
                    ...
                    b.ToTable("permission_override", (string)null);

                    b.HasComment("Stores data related to permission overrides for commands.");
                });
            ...
            modelBuilder.Entity("AkkoCore.Services.Database.Entities.PlayingStatusEntity", b =>
                {
                    ...
                    b.ToTable("playing_statuses", (string)null);

                    b.HasComment("Stores data related to the bot's Discord status.");
                });
            ...
            modelBuilder.Entity("AkkoCore.Services.Database.Entities.PollEntity", b =>
                {
                    ...
                    b.HasComment("Stores data related to a server poll.");
                });
            ...
            modelBuilder.Entity("AkkoCore.Services.Database.Entities.ReminderEntity", b =>
                {
                    ...
                    b.HasComment("Stores reminder data and the context it should be sent to.");
                });
            ...
            modelBuilder.Entity("AkkoCore.Services.Database.Entities.RepeaterEntity", b =>
                {
                    ...
                    b.HasComment("Stores repeater data and the context it should be sent to.");
                });
            ...
            modelBuilder.Entity("AkkoCore.Services.Database.Entities.TagEntity", b =>
                {
                    ...
                    b.HasComment("Stores data related to a tag.");
                });
            ...
            modelBuilder.Entity("AkkoCore.Services.Database.Entities.TimerEntity", b =>
                {
                    ...
                    b.HasComment("Stores a timer that executes actions at some point in the future.");
                });
            ...
            modelBuilder.Entity("AkkoCore.Services.Database.Entities.VoiceRoleEntity", b =>
                {
                    ...
                    b.ToTable("voice_roles", (string)null);

                    b.HasComment("Stores a voice chat role.");
                });
            ...
            modelBuilder.Entity("AkkoCore.Services.Database.Entities.WarnEntity", b =>
                {
                    ...
                    b.HasComment("Stores warnings issued to users on servers.");
                });
            ...
            modelBuilder.Entity("AkkoCore.Services.Database.Entities.WarnPunishEntity", b =>
                {
                    ...
                    b.ToTable("warn_punishments", (string)null);

                    b.HasComment("Stores punishments to be automatically applied once a user reaches a certain amount of warnings.");
                });
            ...
            modelBuilder.Entity("AkkoCore.Services.Database.Entities.ModroleEntity", b =>
                {
                    b.HasOne("AkkoCore.Services.Database.Entities.GuildConfigEntity", "GuildConfigRel")
                        .WithMany("ModrolesRel")
                        .HasForeignKey("GuildIdFK")
                        .HasPrincipalKey("GuildId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_modroles_guild_config_guild_config_rel_id");
