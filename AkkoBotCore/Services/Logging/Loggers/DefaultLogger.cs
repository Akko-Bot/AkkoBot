...
namespace AkkoBot.Services.Logging.Loggers
{
    public class DefaultLogger : ILogger
    {
        ...
        public DefaultLogger(LogLevel minLevel, string timestampFormat, IAkkoFileLogger fileLogger = null)
        {
            ...
            lock (_lock)
            {
                ...
                else
                {
                    var logBody =
                        ...
                        $"Server: {_cmdContext.Guild.Name} [{_cmdContext.Guild.Id}]\n\t" +
                        $"Channel: #{_cmdContext.Channel.Name} [{_cmdContext.Channel.Id}]\n\t" +
                        $"Message: {message}\n";
