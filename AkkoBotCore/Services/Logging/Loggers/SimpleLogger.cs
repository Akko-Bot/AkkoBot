...
namespace AkkoBot.Services.Logging.Loggers
{
    public class SimpleLogger : ILogger
    {
        ...
        public SimpleLogger(LogLevel minLevel, string timestampFormat, IFileLogger fileLogger = null)
        {
