...
public class CommandPlaceholders : IPlaceholderFormatter
{
    ...
    protected readonly Dictionary<string, Func<CommandContext, object?>> placeholderActions = new()
    {
        ...
        ["server.avatar"] = (context) => context.Guild?.IconUrl,
        ["server.banner"] = (context) => context.Guild?.BannerUrl,
        ["server.splash"] = (context) => context.Guild?.SplashUrl,
        ["server.discoverysplash"] = (context) => context.Guild?.DiscoverySplashUrl,
        ["server.creationdate"] = (context) => context.Guild?.CreationTimestamp.ToDiscordTimestamp(TimestampFormat.ShortDateTime),
        ...
        ["channel.creationdate"] = (context) => context.Channel.CreationTimestamp.ToDiscordTimestamp(TimestampFormat.ShortDateTime),
