...
[assembly: SuppressMessage("Performance", "CA1826:Do not use Enumerable methods on indexable collections", Justification = "Collection can be empty.", Scope = "member", Target = "~M:AkkoCore.Commands.Modules.Self.OwnerCommands.SetAvatarAsync(DSharpPlus.CommandsNext.CommandContext)~System.Threading.Tasks.Task")]
[assembly: SuppressMessage("Performance", "CA1826:Do not use Enumerable methods on indexable collections", Justification = "Collection can be empty.", Scope = "member", Target = "~M:AkkoCore.Extensions.DiscordChannelExt.GetLatestMessageAsync(DSharpPlus.Entities.DiscordChannel,DSharpPlus.DiscordClient)~System.Threading.Tasks.Task{DSharpPlus.Entities.DiscordMessage}")]
